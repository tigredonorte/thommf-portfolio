...
1. AWS documentation for the specific service
2. Terraform AWS provider documentation
3. Your AWS account limits and permissions

Remember to never commit sensitive information like AWS keys or certificate ARNs to version control!
